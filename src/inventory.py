...
inventory = {
    ...
    """You will not have to work for the rest of your life, there are enough spoils in these coiffers to make King Midas jealous
    ...
    "poison": Item("Ricin \n",
    """You have touched one of the most deadliest of poisons in the world, sorry, but you are dead now. Goodbye..."""),
